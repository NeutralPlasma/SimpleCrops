...
class CommandDropsGui(private val id: String, private val cropConfiguration: CropConfiguration, private val player: Player,
    ...
    private val gui : InventoryCreator = InventoryCreator(45, HexUtil.colorify(
        TextUtil.formatString(locale.getLocale(Locales.COMMANDS_GUI_TITLE),
            "{id}:${id}")))
    ...
    private fun load(){
        ...
        if(itemMeta != null){
            ...
            val lore = TextUtil.colorFormatList(locale.getList(Locales.COMMANDS_GUI_ADD_NEW_LORE))
            itemMeta.lore = lore
        ...
        icon.addClickAction() {
            ...
            for(string in TextUtil.colorFormatList(locale.getList(Locales.COMMANDS_GUI_ADD_INFO))){
